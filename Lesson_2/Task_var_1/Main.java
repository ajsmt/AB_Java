...
/*
 *  Уточнения:
 *  1) Скобочнаяа последовательность должна быть сбалансированной(т.е. количество '(' равно
 *      количеству ')', а также ')' не может встречаться до '(' ), 
 *      в ином случае будет обработано исключение
...
public class Main {
    ...
    public static String nestingRemove(String input) throws InvalidInput {
        ...
        for (char i : input.toCharArray()) {
            ...
            if (closeBraketsCount > openBraketsCount) {
