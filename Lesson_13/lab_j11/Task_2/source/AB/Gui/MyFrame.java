...
public class MyFrame extends JFrame {
    ...
    private CourseSetStrategy strategy;
    ...
    public MyFrame(String title) {
        ...
        strategy = new StreamCourseSetStrategy();

        setResizable(false);
        setLayout(new BorderLayout());
        inputArea = new JTextArea();
        outputArea = new JTextArea();
        inputArea.setPreferredSize(new Dimension(280, 300));
        outputArea.setPreferredSize(new Dimension(280, 300));
        ...
        buttons.add(changeStrategyButton);
        ...
        editButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                courses = strategy.getSet(students);
                writeoutputArea();
            }
        });
        ...
        changeStrategyButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (strategy instanceof StreamCourseSetStrategy) {
                    strategy = new LoopCourseSetStrategy();
                } else {
                    strategy = new StreamCourseSetStrategy();
                }

                JOptionPane.showMessageDialog(MyFrame.this, "Current strategy: " + strategy.getClass().getName(),
                        "Strategy Changed",
